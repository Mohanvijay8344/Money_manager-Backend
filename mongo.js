...
// db.movies.find({rating: {$nin: [8.6,7]}}, {_id:0, name:1, rating:1})

// db.movies.find({rating: {$ne: [8.6,7]}}, {_id:0, name:1, rating:1})

// db.movies.find({rating: {$gte: 8.5, $lte: 9}}, {_id:0, name:1, rating:1})

// db.movies.find({}, {_id:0, name:1, rating:1}).sort({name: 1}).limit(3)

// db.movies.find({}, {_id:0, name:1, rating:1}).sort({name: 1}).limit(3).skip(3)
